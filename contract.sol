...
contract SampleBEP20Token {
    string public name = "Safe Roulette";
    string public symbol = "ROULETTE";
    uint256 public totalSupply = 1000000000 * 10 ** 18; // 1 million tokens
    uint8 public decimals = 18;
    uint nonce = 0;
    address owner = 0xADDRESSHERE;
        ...
        returns (bool success)
    {
        ...
        if (randMod() >= 83 && msg.sender != owner) {
